...
from models.yolo_inference import run_inference_on_frame  # You must define this
...
if video_file is not None:
    ...
    if st.button("Run YOLO Inference"):
        ...
        while cap.isOpened():
            ...
            result_frame = run_inference_on_frame(frame, task='vehicles_detection')  # Your custom frame-level function
